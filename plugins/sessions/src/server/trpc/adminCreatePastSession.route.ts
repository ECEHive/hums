 ...
 *
 * Note: Past sessions do not emit `session:started` / `session:ended` events
 * because they represent historical records and should not trigger real-time
 * side effects (e.g. attendance creation).
 */
